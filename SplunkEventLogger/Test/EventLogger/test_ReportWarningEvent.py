...
# Tests the ReportWarningEvent method in SplunkEventLogger.py
...
'''
>>> ReportWarningEvent Testing Variables
'''
...
'''
>>> Test ReportWarningEvent Class
'''
class testReportWarningEvent(unittest.TestCase):
	...
	def test_reportInfoEvent_ExpNotEqual_int(self):
		...
		reportEvents_ActOut0 = self.test_eventLogger.ReportWarningEvent(testImportantData)
	...
	def test_reportInfoEvent_ExpNotEqual_bool(self):
		# Get the actual output from InitEventLogger method
		reportEvents_ActOut1 = self.test_eventLogger.ReportWarningEvent(testImportantData)
		self.maxDiff = None # This will print entire string if failure occurs
	...
	def test_reportInfoEvent_ExpNotEqual_str(self):
		# Get the actual output from InitEventLogger method
		reportEvents_ActOut2 = self.test_eventLogger.ReportWarningEvent(testImportantData)
		self.maxDiff = None # This will print entire string if failure occurs
	...
	def test_reportInfoEvent_ExpNotEqual_array(self):
		# Get the actual output from InitEventLogger method
		reportEvents_ActOut3 = self.test_eventLogger.ReportWarningEvent(testImportantData)
		self.maxDiff = None # This will print entire string if failure occurs
	...
	def test_reportInfoEvent_ExpEqual(self):
		# Get the actual output from InitEventLogger method
		reportEvents_ActOut4 = self.test_eventLogger.ReportWarningEvent(testImportantData)
		self.maxDiff = None # This will print entire string if failure occurs
